...
class ColorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create color" do
    assert_difference("Color.count") do
      post colors_url, params: { color: { hex_code: @color.hex_code, palette_id: @color.palette_id } }
    end
  ...
  test "should update color" do
    patch color_url(@color), params: { color: { hex_code: @color.hex_code, palette_id: @color.palette_id } }
