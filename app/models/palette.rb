class Palette < ApplicationRecord
  ...
  validates :layout,  inclusion: { in: %w(rows columns) }
  ...
  def validate_color
    ...
    unless color_regexes.any? { |regex| regex.match?(background) } || css_color_names.include?(background&.downcase)
      errors.add(:background, "not a valid color" )
    end
  end
end
